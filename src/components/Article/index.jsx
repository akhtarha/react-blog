    ...
    <article className="mt-90">
      <header className="text-center mb-40">
        ...
        <div className="link-color-default fs-12">
          <a href="index.html">News</a>,<time>May 13, 2017</time>
        </div>
      </header>
      ...
      <div className="card-block">
        <p className="text-justify">
          ...
          Likeness, moveth fruitful behold. Open evening a air us behold. Saying
          above moving second a subdue likeness after also second.
        </p>
